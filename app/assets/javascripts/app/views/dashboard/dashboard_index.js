SBD.DashboardIndexView = Ember.View.extend({
  init: function() {
    console.log('dash index view');
  },

  click: function() {
    return console.log('cliicked on the dasssh');
  },
...
//         var sections = [
//         ].slice.call(elem.parentNode.childNodes) .filter(function (element) {
...
//         });
//         var sum = dimensions.reduce(function (a, b) {
//             return a + b
//         });
//         var cumulative = 0;
